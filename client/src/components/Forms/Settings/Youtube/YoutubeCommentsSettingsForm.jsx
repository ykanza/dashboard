...
export default function YoutubeCommentsSettingsForm({handleWidgetReq, widgetToUpdate}) {
    ...
    return (
        <form noValidate id={`form${WidgetTypeEnum.YOUTUBE_COMMENTS}`} autoComplete="off" onSubmit={handleSubmit}>
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <Typography gutterBottom className={classes.typographyClass}>Check the comments</Typography>
                </Grid>
                <Grid item xs={12}>
                    <TextField
